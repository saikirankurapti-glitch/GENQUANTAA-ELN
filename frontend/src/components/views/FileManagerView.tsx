...
import { HardDrive, FileText, Image, FileSpreadsheet, Download, Upload, Share2 } from 'lucide-react';
              ...
              {files.map((file) => (
                <tr key={file.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-3.5 px-4 text-right">
                    <button className="text-xs font-semibold text-blue-600 hover:text-blue-700 p-1">
